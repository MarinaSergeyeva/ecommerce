import {DocumentPdfIcon, DocumentsIcon, DocumentTextIcon, ImageIcon, LinkIcon} from '@sanity/icons'
...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'body',
      title: 'Body',
      description: 'Rich text content, including sub headings, links, images, and PDFs.',
      type: 'array',
      of: [
        {
          type: 'block',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'number',
              title: 'Image Size',
              description: 'Pixel width of the image, leave empty for auto scaling.',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              description: 'Height for the PDF display, leave empty for auto scaling.',
